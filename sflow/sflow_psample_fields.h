...
SFLOWPS_FIELDDATA(SFLOWPS_PSAMPLE_ATTR_TUNNEL, 0, "tunnel header")
    ...
    /* commands attributes */
SFLOWPS_FIELDDATA(SFLOWPS_PSAMPLE_ATTR_GROUP_REFCOUNT, 0, "group reference count")
...
SFLOWPS_FIELDDATA(SFLOWPS_PSAMPLE_ATTR_OUT_TC_OCC, 8, "egress queue depth in bytes")
SFLOWPS_FIELDDATA(SFLOWPS_PSAMPLE_ATTR_LATENCY, 8, "transit latency in nanoseconds")
